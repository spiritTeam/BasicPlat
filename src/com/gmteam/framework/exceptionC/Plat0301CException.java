 ...
 * 请参看:
 * {@linkplain com.gmteam.framework.component.UGA.cache.FrameworkUgaCLU FrameworkUgaCLU}
 * @author wh
 */
public class Plat0301CException extends PlatCException {
     ...
     */
    public Plat0301CException() throws Plat0000CException {
     ...
     * @throws Plat0000CException 若设置的分类码或内部码不符合规范
     */
    public Plat0301CException(String msg) throws Plat0000CException {
     ...
     * @throws Plat0000CException 若设置的分类码或内部码不符合规范
     */
    public Plat0301CException(Throwable cause) throws Plat0000CException {
     ...
     * @throws Plat0000CException 若设置的分类码或内部码不符合规范
     */
    public Plat0301CException(String msg, Throwable cause) throws Plat0000CException {
