...
public interface GeneralDao<T>  {
     ...
     * @return 若插入成功返回1，
     */
    public int insert(Object newData) throws Plat0101CException;
     ...
     * @return 存储记录数
     */
    public int save(Object aData) throws Plat0101CException;
     ...
     * @return 更新记录条数
     */
    public int update(Object updateData) throws Plat0101CException;
     ...
     * @return 删除记录条数
     */
    public int delete(Object parameter) throws Plat0101CException;
     ...
     * @return 结果总数
     */
    public int getCount(Object parameter) throws Plat0101CException;
     ...
     */
    public T getInfoObject(Object idObj) throws Plat0101CException;
     ...
     */
    public List<T> queryForList(Object parameter) throws Plat0101CException;
}