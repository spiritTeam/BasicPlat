...
public class Plat0001CException extends PlatCException {
     ...
     */
    public Plat0001CException() throws Plat0000CException {
     ...
     * @throws Plat0000CException 若设置的分类码或内部码不符合规范
     */
    public Plat0001CException(String msg) throws Plat0000CException {
     ...
     * @throws Plat0000CException 若设置的分类码或内部码不符合规范
     */
    public Plat0001CException(Throwable cause) throws Plat0000CException {
     ...
     * @throws Plat0000CException 若设置的分类码或内部码不符合规范
     */
    public Plat0001CException(String msg, Throwable cause) throws Plat0000CException {
